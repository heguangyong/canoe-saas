	...
	<view>
		...
		<view class="padding-xs text-center margin-top solid-top">
			<view class="text-lg padding-xs">
				<texxt class="margin-top text-bold text-lg ">☆  地图指引  ☆</texxt>
			</view>
		</view>
		<view class="text-bold">【产品交流会活动地点】</view>
		<view class="margin-top">
			<text class="  padding-sm" space="nbsp" >
				地址：金砖大厦7层（上海市浦东新区陆家嘴环路333号）
			</text>
		</view>
		<view class="margin-top text-bold">【午宴】</view>
		<view class="margin-top">
			<text class="  padding-sm" space="nbsp" >
				地址：浦之舟餐厅（上海市浦东新区滨江大道3688号）
			</text>
		</view>
