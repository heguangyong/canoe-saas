...
<template>
    <view>
            ...
            <block v-for="(item,index) in list" :key="index">
                ...
                <view class="cu-list menu-avatar no-padding">
                    <view class="cu-item  card-radius margin-top-xxs margin-left-xs margin-right-xs margin-bottom-xs shadow bg-white.light"  v-for="(subItem,subIndex) in item.subList" :key="subIndex">
                        <view v-if="subItem.card_type=='biz'" class="cu-avatar round lg" @tap="goDetail(subItem.id)" @longpress="popupOperateCard(list[index].group,subIndex,subItem)">
                            <image :src="subItem.avatar" mode="aspectFill" class="cu-avatar round lg"></image>
                        </view>
                        <view v-else class="cu-avatar round lg" @tap="goDetail(subItem.id)" @longpress="popupOperateCard(list[index].group,subIndex,subItem)">
                            <image :src="subItem.avatar" mode="aspectFill" class="cu-avatar round lg"></image>
                        </view>
        ...
        <view class="cu-bar bg-white tabbar border shop foot">
            ...
            <button class="action" @tap="goCard" >
...
<script>
    ...
    export default {
        ...
        onReady() {
            let that = this;
            that.showSchoolCard=that.corpUser.showSchoolCard;
        },
        ...
        methods: {
            ...
            async setWriteOff(isCancel){
                ...
                console.log('核销员更新完成',that.cardId,that.selectedGroupKey,that.selectedSubIndex,that.selectedItem);
                that.getList();
